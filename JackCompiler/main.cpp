...
int main(int argc, char* argv[])
{
	...
	files_to_process.push_back("tests/ch10/Square/Main.jack");
	files_to_process.push_back("tests/ch10/Square/Square.jack");
	files_to_process.push_back("tests/ch10/Square/SquareGame.jack");
